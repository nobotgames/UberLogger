...
public static class UberDebug
{
    ...
    {
        UberLogger.Logger.Log("", context, LogSeverity.Warning, message, null, par);
    }

    [StackTraceIgnore]
    static public void Log(string message, params object[] par)
    {
        UberLogger.Logger.Log("", null, LogSeverity.Warning, message, null, par);
    }

    [StackTraceIgnore]
    static public void LogChannel(UnityEngine.Object context, string channel, string message, params object[] par)
    {
        UberLogger.Logger.Log(channel, context, LogSeverity.Message, message, null, par);
    }

    [StackTraceIgnore]
    static public void LogChannel(string channel, string message, params object[] par)
    {
        UberLogger.Logger.Log(channel, null, LogSeverity.Message, message, null, par);
    }
